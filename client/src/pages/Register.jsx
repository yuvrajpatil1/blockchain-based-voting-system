...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Backend expects: name, email, password, walletAddress (optional)
      const dataToSubmit = {
      ...
      console.log("Submitting registration:", dataToSubmit);
        ...
        <div className="lg:w-2/5 bg-black p-8 md:p-16 flex flex-col relative overflow-hidden border-r border-gray-800">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 md:mb-12 mb-6 md:text-lg text-sm">
              Create your secure account and participate in transparent,
            ...
            <div className="space-y-6 hidden md:block">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Real-time, tamper-proof election results
                  </p>
                </div>
              </div>
            </div>
